# !pip install optuna transformers sentencepiece datasets sacremoses accelerate -U
...
from transformers import AutoModelForSequenceClassification, AutoTokenizer, EarlyStoppingCallback, TrainingArguments, Trainer, TransfoXLForSequenceClassification
...
model = TransfoXLForSequenceClassification.from_pretrained("transfo-xl-wt103", num_labels=2, use_auth_token=True)
...
args = TrainingArguments(
    output_dir=f"/content/drive/MyDrive/ImageArg-Shared-Task/text_model_trainer/{dataset}/transformer_xl/",
